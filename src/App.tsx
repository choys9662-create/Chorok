        ...
        return <Suspense fallback={
          <div className="max-w-md mx-auto min-h-screen bg-background flex items-center justify-center">
            <div className="flex flex-col items-center gap-4">
              <div className="w-12 h-12 rounded-full flex items-center justify-center animate-pulse-glow" style={{ background: 'rgba(0, 255, 0, 0.15)', border: '1px solid rgba(0, 255, 0, 0.3)' }}>
                <TreePine className="w-6 h-6" style={{ color: '#00FF00' }} />
              </div>
              <p className="text-body-s" style={{ color: 'var(--text-secondary)' }}>숲을 불러오는 중...</p>
            </div>
          </div>
        }>
