...
export function TimerScreen({ book, onComplete, onBack, onBookSelect }: TimerScreenProps) {
  ...
  if (showSummary) {
    return (
      <div className="max-w-md mx-auto min-h-screen flex flex-col bg-[#0a0a0a] text-white p-6 animate-fade-in relative overflow-hidden">
        {/* Background glow */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-80 h-80 rounded-full blur-3xl opacity-20" style={{ background: 'rgba(0, 255, 0, 0.3)' }}></div>
        </div>

        <div className="flex-1 flex flex-col items-center justify-center relative z-10">
          <div className="w-24 h-24 rounded-full flex items-center justify-center mb-6 animate-pulse-glow" style={{ background: 'rgba(0, 255, 0, 0.15)', border: '2px solid rgba(0, 255, 0, 0.3)' }}>
            <Trees className="w-12 h-12" style={{ color: '#00FF00' }} />
          </div>

          <h2 className="text-h1 text-white mb-2">독서 완료!</h2>
          <p className="text-body-s mb-10" style={{ color: 'var(--text-secondary)' }}>오늘도 숲이 조금 더 무성해졌어요</p>

          <div className="w-full rounded-2xl p-6 mb-6 space-y-6" style={{ background: 'var(--surface-2)', border: '1px solid var(--border-default)' }}>
            <div className="flex justify-between items-center pb-4" style={{ borderBottom: '1px solid var(--border-subtle)' }}>
              <span className="text-body-s" style={{ color: 'var(--text-secondary)' }}>총 독서 시간</span>
              <span className="text-h2 font-mono" style={{ color: '#00FF00' }}>{formatTime(seconds)}</span>
            </div>

            <div className="flex justify-between items-center pb-4" style={{ borderBottom: '1px solid var(--border-subtle)' }}>
              <span className="text-body-s" style={{ color: 'var(--text-secondary)' }}>기록한 초서</span>
              <span className="text-h2 text-white flex items-center gap-2">
                {sessionChoseos.length} <span className="text-caption font-normal" style={{ color: 'var(--text-tertiary)' }}>개</span>
              </span>
            </div>

            <div className="flex justify-between items-center">
              <span className="text-body-s" style={{ color: 'var(--text-secondary)' }}>읽은 페이지</span>
              <div className="flex items-center gap-3">
                ...
                <span className="text-h2 text-white w-12 text-center">{pagesRead}</span>
                <button
          ...
          <div className="flex items-center gap-2 text-body-s px-5 py-2.5 rounded-full mb-8" style={{ background: 'rgba(0, 255, 0, 0.1)', color: '#00FF00', border: '1px solid rgba(0, 255, 0, 0.2)' }}>
        ...
        <button
          ...
          className="relative z-10 w-full text-black py-4 rounded-xl font-bold shadow-neon active:scale-[0.98] transition-all text-body-s"
